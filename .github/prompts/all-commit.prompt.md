---
agent: 'agent'
description: 'Realiza commit inteligente de todos los cambios del repositorio siguiendo Conventional Commits'
---
...
- si no hay cambios mostrar: "No hay cambios pendientes para commitear."
